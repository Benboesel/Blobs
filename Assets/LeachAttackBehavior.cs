...
public class LeachAttackBehavior : MonoBehaviour, IAttackBehavior
{
    ...
    private IEnumerator Leach()
    {
        ...
        Transform anchor = new GameObject("LeachAnchor").transform;
        ...
        transform.DOLocalJump(Vector3.zero, JumpHeight, JumpNum, JumpDuration);
        ...
        while (true)
        {
            ...
            anchor.position = currentTarget.GetTop() + (transform.localScale.x * Vector3.up * 0.5f);
